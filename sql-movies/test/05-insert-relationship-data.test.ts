...
const insertMovieActors = (
  ...
  let filtered = actorRows.filter(actorRows => actors.includes(actorRows.full_name))
...
const insertMovieDirectors = (
  ...
  let filtered = directorRows.filter(directorRows => directors.includes(directorRows.full_name))
...
const insertMovieKeywords = (
  ...
  let filtered = keywordRows.filter(keywordRows => keywords.includes(keywordRows.keyword))
...
const insertMovieProductionCompanies = (
  ...
  let filtered = productionCompanyRows.filter(productionCompanyRows => productionCompanies.includes(productionCompanyRows.company_name))
